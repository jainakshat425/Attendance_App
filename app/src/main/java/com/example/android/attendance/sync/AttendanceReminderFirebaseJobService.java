...
public class AttendanceReminderFirebaseJobService extends JobService {
    ...
    public boolean onStartJob(final JobParameters jobParameters) {
        ...
        mBackgroundTask = new AsyncTask() {
            ...
            protected Object doInBackground(Object[] params) {
                Context context = AttendanceReminderFirebaseJobService.this;
                ReminderTasks.executeTask(context, ReminderTasks.ACTION_ATTENDANCE_REMINDER);
                return null;
            }
